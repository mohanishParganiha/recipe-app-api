...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(
            email='otheruser@example.com', password='othertestpass123')
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='sample recipe title',
            link='https://examplecom/recipe.pd',
    ...
    def test_delete_other_user_recipe_error(self):
        ...
        new_user = create_user(
            email='seconduser@example.com', password='testpass123')
    ...
    def test_create_tag_on_update(self):
        """test creating tag on updating recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_tag(self):
        """test assigning an existing tag when creating recipe"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """test creating recipe with new ingredietns"""
        payload = {
    ...
    def test_create_ingredient_on_update(self):
        """test creating an ingredients when updating a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assing_ingredietn(self):
        ...
        paylaod = {'ingredients': [{'name': 'Chilli'}]}
        url = detail_url(recipe.id)
...
class ImageUploadTests(TestCase):
    """test class for image upload API."""
